...
@Data
public class ProductSkuModifyReq {
    @NotNull(message = "主键不能为空")
    @ApiModelProperty(name = "id", value = "主键",example="2352534",required = true)
    private Long id;
    @NotNull(message = "产品名称不能为空")
    @ApiModelProperty(name = "name", value = "产品名称",example="黄金",required = true)
    private String name;
    @NotNull(message = "产品简介不能为空")
    @ApiModelProperty(name = "summary", value = "产品简介",example="至尊黄金会员",required = true)
    ...
    @ApiModelProperty(name = "serverVal", value = "type=0 存放本产品的服务时间(单位：分)；type=1 本产品的最大服务次数 ",example="999")
    private Integer serverVal;
    @ApiModelProperty(name = "permission", value = "0-都可购买 1-只限实验室下属导师购买 2-只限企业机构购买",example="0")
