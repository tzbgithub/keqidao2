...
public class Invite {
    ...
    public enum Column {
        ...
        invitePhone("invite_phone", "invitePhone", "VARCHAR", false),
        inviteName("invite_name", "inviteName", "VARCHAR", false),
        invitePosition("invite_position", "invitePosition", "VARCHAR", false),
