...
public class LogBehaveDynamicExample {
    ...
    public LogBehaveDynamicExample() {
    ...
    public LogBehaveDynamicExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LogBehaveDynamicExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LogBehaveDynamicExample page(Integer page, Integer pageSize) {
