package com.qidao.application.entity.invoice;
...
public class InvoiceExample {
    ...
    public InvoiceExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public InvoiceExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public InvoiceExample page(Integer page, Integer pageSize) {
