...
public class LinkDynamicChannelExample {
    ...
    public LinkDynamicChannelExample() {
    ...
    public LinkDynamicChannelExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LinkDynamicChannelExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LinkDynamicChannelExample page(Integer page, Integer pageSize) {
