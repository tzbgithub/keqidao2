...
public class MsgRecordExample {
    ...
    public MsgRecordExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public MsgRecordExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public MsgRecordExample page(Integer page, Integer pageSize) {
