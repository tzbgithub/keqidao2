...
public class LinkLabelExample {
    ...
    public LinkLabelExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LinkLabelExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LinkLabelExample page(Integer page, Integer pageSize) {
