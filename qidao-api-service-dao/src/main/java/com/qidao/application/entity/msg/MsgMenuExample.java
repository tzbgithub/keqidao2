...
public class MsgMenuExample {
    ...
    public MsgMenuExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public MsgMenuExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public MsgMenuExample page(Integer page, Integer pageSize) {
