 ...
 * @date : 2021/3/11 2:26 PM
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "EasemobGetChatRoomMuteListRes", description = "[响应]获取禁言列表")
public class EasemobGetChatRoomMuteListRes implements Serializable {

    @JsonIgnore
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(name = "mutedUserList", value = "被禁言的用户列表")
    List<MutedUser> mutedUserList;
