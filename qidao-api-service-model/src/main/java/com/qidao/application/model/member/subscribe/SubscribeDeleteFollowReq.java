...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value = "SubscribeDeleteFollowReq", description = "[请求]删除单个关注")
public class SubscribeDeleteFollowReq implements Serializable {
    @JsonIgnore
    ...
    @NotNull(message = "被关注的对象Id不能为空")
    @ApiModelProperty(name = "subscribeId", value = "被关注的(会员的用户id)/(组织id)",required = true,example = "142663454097410")
