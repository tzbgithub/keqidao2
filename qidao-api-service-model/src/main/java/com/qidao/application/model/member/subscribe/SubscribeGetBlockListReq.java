...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value = "SubscribeGetBlockListReq", description = "[请求]分页获取屏蔽列表")
public class SubscribeGetBlockListReq implements Serializable {
    @JsonIgnore
    ...
    @Max(value = 2,message = "屏蔽对象的身份-值最大为2")
    @ApiModelProperty(name = "subscribeType",value = "屏蔽对象的身份,0-会员,1-组织机构,2-仅实验室", required = true, example = "0")
