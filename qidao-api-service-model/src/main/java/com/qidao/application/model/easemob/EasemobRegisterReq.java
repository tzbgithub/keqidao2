 ...
 * @date : 2021/3/3 10:56 AM
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "EasemobRegisterReq", description = "[请求]注册单个用户(授权)")
public class EasemobRegisterReq implements Serializable {
    ...
    private List<EasemobRegisterReq.User> users;
