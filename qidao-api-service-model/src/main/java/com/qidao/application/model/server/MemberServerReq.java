...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel("个人发布需求展示请求参数")
public class MemberServerReq extends BasePageQuery {

    @ApiModelProperty(value = "模糊搜索关键字",example = "关键字" , hidden = true)
    private String keyword;

    @ApiModelProperty(value = "当前用户ID",example = "123",required = true)
    @NotNull(message = "当前用户ID不能为空")
    private Long memberId;

    @ApiModelProperty(value = "对象ID", notes = "如果为空查看memberId用户的空间",example = "123",required = true)
